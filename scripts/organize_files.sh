...
if [ -n "$ROOT_TEST_FILES" ]; then
    ...
    echo ""
    echo "🚀 Moving files to tests/ folder..."
    mv $ROOT_TEST_FILES "$TESTS_DIR/"
    echo "✅ Files moved successfully!"
else
    echo "✅ No misplaced test/demo files found in project root."
fi
...
if [ -n "$BACKEND_TEST_FILES" ]; then
    ...
    echo "✅ No misplaced test files found in backend directory."
fi

echo ""
echo "📋 Final structure in tests/ folder:"
